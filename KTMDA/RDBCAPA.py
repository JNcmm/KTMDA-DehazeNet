...
def validation(net, val_data_loader, device):
    ...
    for batch_id, (img_orig, img_haze, feb, gama,zft,white) in enumerate(val_data_loader):
        ...
        with torch.no_grad():
            ...
            clean_image = net(feb, white, gama)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--orig_images_path', type=str, default="SOTS/nyuhaze500/clear/")
    parser.add_argument('--hazy_images_path', type=str, default="SOTS/nyuhaze500/hazy/")
    parser.add_argument('--gama_path', type=str, default="SOTS/nyuhaze500/gama/")
    parser.add_argument('--feb_path', type=str, default="SOTS/nyuhaze500/feb/")
    parser.add_argument('--zft_path', type=str, default="SOTS/nyuhaze500/zft/")
    parser.add_argument('--white_path', type=str, default="SOTS/nyuhaze500/white/")
