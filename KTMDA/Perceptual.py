...
class PerceptualLoss(nn.Module):
    def __init__(self, content_layer=2):
        ...
        # style_image = mytransform(style_image).repeat(opt.ba, 1, 1, 1).to(opt.device)
        #
        # with torch.no_grad():
